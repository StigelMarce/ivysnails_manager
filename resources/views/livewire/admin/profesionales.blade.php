        ...
        <div>
            <div x-data="{ pageName: `Profesionales` }">
                <div class="flex flex-wrap items-center justify-between gap-3 pb-6">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90" x-text="pageName">Profesionales</h2>
                        ...
                        <li>
                            <a class="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400"
                                ...
                                <svg class="stroke-current" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.0765 12.667L10.2432 8.50033L6.0765 4.33366" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </a>
                        </li>
                        ...
                        <table class="w-full table-auto">
                            <thead>
                                <tr class="border-b border-gray-200 dark:divide-gray-800 dark:border-gray-800">
                                    ...
                                    <th class="px-5 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Nombre</th>
                                    <th class="px-5 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Especialidad</th>
                                    <th class="px-5 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Teléfono</th>
                                    <th class="px-5 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Email</th>
                                    <th class="px-5 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Estado</th>
                                    <th class="px-5 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Fecha Ingreso</th>
                            ...
                            <tbody class="divide-x divide-y divide-gray-200 dark:divide-gray-800">
                                @forelse($profesionales as $profesional)
                                    <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900">
                                        ...
                                        <td class="px-5 py-4 whitespace-nowrap">
                                            <p class="text-sm text-gray-700 dark:text-gray-400">
                                                {{ $profesional->fecha_ingreso->format('d/m/Y') }}
                                            </p>
                                        </td>
                                        <td class="px-5 py-4 whitespace-nowrap">
