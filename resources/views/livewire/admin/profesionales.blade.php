                                    ...
                                    <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900">
                                        ...
                                        <td class="px-5 py-4 whitespace-nowrap">
                                            @if ($profesional->activo)
                                                <span
                                                    class="text-theme-xs rounded-full bg-green-50 px-2 py-0.5 font-medium text-green-700 dark:bg-green-500/15 dark:text-green-500">
                                                    Activo
                                                </span>
                                            @else
                                                <span
                                                    class="text-theme-xs rounded-full bg-red-50 px-2 py-0.5 font-medium text-red-700 dark:bg-red-500/15 dark:text-red-500">
                                                    Inactivo
                                                </span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="px-5 py-4 whitespace-nowrap">
                                            <div x-data="{ open: false }" class="relative flex justify-center">
                                                ...
                                                <div x-show="open" @click.outside="open = false"
                                                    ...
                                                    <form
                                                        action="{{ route('admin.profesionales.destroy', $profesional) }}"
