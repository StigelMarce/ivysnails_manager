<x-app-layout>
    <div class="mx-auto max-w-3xl px-5 py-4 md:p-6">
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-6 py-5">
                <form action="{{ route('admin.profesionales.update', $profesional) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Especialidad -->
                        <div>
                            <label for="especialidad" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        ...
                        <!-- Fecha de Ingreso -->
                        <div>
                            <label for="fecha_ingreso" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
