  ...
  <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
    ...
    <a href="index.html">
      ...
      <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
        src="{{ Vite::asset('resources/images/logo/logo-icon.svg') }}" alt="Logo" />
    </a>
  </div>
  <!-- SIDEBAR HEADER -->
    ...
    <nav x-data="{selected: $persist('Dashboard')}">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <!-- Menu Item Profile -->
          <li>
            <a href="profile.html" @click="selected = (selected === 'Profile' ? '':'Profile')" class="menu-item group"
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            ...
            <div class="overflow-hidden transform translate"
              ...
              <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                <li>
                  <a href="signin.html" class="menu-dropdown-item group dark:text-white"
                    :class="page === 'signin' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                    {{ __('Sign In') }}
                  </a>
                </li>
                <li>
                  <a href="signup.html" class="menu-dropdown-item group dark:text-white"
