<header x-data="{menuToggle: false}"
  class="relative top-0 z-99999 flex w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900 transition-colors duration-300 ease-in-out">
    ...
    <div :class="menuToggle ? 'flex' : 'hidden'"
      ...
      <div class="2xsm:gap-3 flex items-center gap-2">
        ...
        <div class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
          ...
          <div x-show="dropdownOpen"
            class="absolute right-0 mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 dark:border-gray-700 bg-white p-3 sm:w-[361px] shadow-theme-lg dark:bg-gray-800 z-50">
      ...
      <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
        <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
          ...
          <span class="text-theme-sm mr-1 block font-medium"> {{ auth()->user()->name ?? 'Unknown' }} </span>
        ...
        <!-- Dropdown Start -->
        <div x-show="dropdownOpen"
          class="absolute z-50 border-gray-200 shadow-theme-lg dark:bg-gray-800 right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 dark:border-gray-700 bg-white p-3">
          <div>
